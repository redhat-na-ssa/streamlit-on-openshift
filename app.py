...
def cs_sidebar():
    ...
    st.sidebar.markdown('''[<img src='data:image/png;base64,{}' class='img-fluid' width=32 height=32>](https://streamlit.io/)'''.format(img_to_bytes("media/logomark_website.png")), unsafe_allow_html=True)
    st.sidebar.header('Soap BOX!!!')
